...
export default function App() {
  ...
  async function onFileUpload(fileList: FileList | null) {
    ...
    try {
      ...
      await refresh()
      setServerMessage(`Готово: ${files.length} файл(ов), типы отчётов — ${result.analysis.reportTypes.join(', ')}`)
